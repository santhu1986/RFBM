...
public String Branch(String Bn,String Badd,String Zc,String Ct,String St,String Cy) throws IOException
{
    ...
    driver.findElement(By.id(Pr.getProperty("BrNm"))).sendKeys(Bn);
    driver.findElement(By.id(Pr.getProperty("BrAd"))).sendKeys(Badd);
    driver.findElement(By.id(Pr.getProperty("BrZc"))).sendKeys(Zc);
    Sleeper.sleepTightInSeconds(4);
    Select Country=new Select(driver.findElement(By.id(Pr.getProperty("BrCntry"))));
    Country.selectByVisibleText(Ct);
    Sleeper.sleepTightInSeconds(4);
